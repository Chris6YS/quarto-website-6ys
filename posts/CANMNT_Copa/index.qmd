...
The Canadian Men's National Team (CanMNT) will participate at the Copa America for the first time. This marks a new era for the team, as Jesse Marsch takes charge of competitive fixtures for the first time.
...
rtable_copa1 <-reactable(data,
  ...
  columns = list(
    ...
    foot = colDef(maxWidth = 75, name = "Footedness", align = "center"),
    height = colDef(maxWidth = 100, name = "Height (cm)", align = "center"),
    age = colDef(maxWidth = 65, name = "Age", align = "center"),
    ps = colDef(maxWidth = 82, name = "College/Uni*", align = "center"),
    player_head = colDef(
      name = "",
      maxWidth = 55,
      align = "center",
...
::: {layout-ncol="2" layout-valign="center"}
![](images2/elo_png.png){width="500"}

![](images2/fifa_png.png){width="\"500"}
:::
