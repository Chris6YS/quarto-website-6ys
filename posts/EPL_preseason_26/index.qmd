...
The English Premier League (EPL) pre-season is underway. It's a time for fitness, opportunities for youth, team bonding, squad building and tactical trials among other things. Match outcomes are largely meaningless, but can influence the narrative, tone and group morale heading into the new campaign. So far over 90 pre-season matches are scheduled for EPL clubs. <br> <br>This post summarizes pre-season schedules for each EPL team ahead of the 2026/2027 campaign that begins on August 21st 2026. Updates will be provided periodically.
...
arsenal <-reactable(
  ...
  columns = list(
    ...
    match_report = colDef(style = list(color = "black", fontSize = "15px"), show = TRUE, align = "center", maxWidth = 125, name = 'Match Report',
